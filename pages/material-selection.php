        ...
        <section class="project" id="project">
            ...
            <?php
                ...
                while ( $loop->have_posts() ) : $loop->the_post();
                    ...
                    $colors = wp_list_pluck( $attrs[ "pa_color"]->get_terms(), "name");
                    $sizes = wp_list_pluck( $attrs[ "pa_size"]->get_terms(), "name");
                    
                    $name = strtolower( $product->get_name());
                    $attachment_ids = $product->get_gallery_image_ids();
                    
                    $white_dress_front_img_src = wp_get_attachment_image_src( get_post_thumbnail_id( $loop->post->ID ), 'single-post-thumbnail' )[ 0];
                    $white_dress_back_img_src  = wp_get_attachment_url( $attachment_ids[ 0]);
                    $black_dress_front_img_src = wp_get_attachment_url( $attachment_ids[ 1]);
                    $black_dress_back_img_src  = wp_get_attachment_url( $attachment_ids[ 2]);
            ?>
            <div class="sales-item">
                <a href="#dress-section">
                    <img class="apparel" src="<?php echo $white_dress_front_img_src; ?>" 
                                         data-white-dress-back-img-src="<?php echo $white_dress_back_img_src; ?>"
                                         data-black-dress-front-img-src="<?php echo $black_dress_front_img_src; ?>"
                                         data-black-dress-back-img-src="<?php echo $black_dress_back_img_src; ?>"
                                         alt="project image" data-id="<?php echo $product->get_id(); ?>">
                </a>
                <div class="cart-item">
                ...
                <div class="dress_colors" data-values="<?php echo esc_html( json_encode( $colors)); ?>" data-default-value="<?php echo $default_attrs[ 'pa_color']; ?>" hidden></div>
                <a id="dress-section" href="#map-section">
                    <div class="dress_sizes" data-default-value="<?php echo $default_attrs[ 'pa_size']; ?>">
                        <?php
                            foreach( $sizes as $size)
                                printf( '<button class="button" value="%s"><div class="before"></div>%s</button>', $size, strtolower( $size));
        ...
        <section id="taglines" class="taglines">
            ...
            <div style="display: flex">
                <input type="textbox" placeholder="Enter your preferred tagline(Optional)" style="justify-self: center;"></input>
            </div>
        </section>
