...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <?php
        if( !empty( $button_text))
            printf( '<a href="%s" class="shipping-calculator-button">%s</a>', esc_url( wc_get_checkout_url()), esc_html( $button_text));
    ?>
	<!--<?php printf( '<a href="%s" class="shipping-calculator-button">%s</a>',  esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>-->
